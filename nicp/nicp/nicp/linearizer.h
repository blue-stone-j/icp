...
class Linearizer
{
 public:
  ...
  /**
   *  Method that returns the inliers found by the Linearizer in the update step.
   *  @return a float value representing the inliers found by the Linearizer in the update step.
   *  @see error()
   */
 ...
 protected:
  ...
  bool _demotedToGeneralizedICP; // use common icp rather than nicp
  bool _zScaling;
  float _scale; // weight of normal
};
