...
/*
   ...
   The prior has to affect the transform between the current and the reference vertex.
   ...
   Since we are operating on a manifold measurement space, the information matrix in the error
   ...
   2) get the information of the error (omega), through the errorInformation(invT) function
