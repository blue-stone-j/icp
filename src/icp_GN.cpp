...
namespace my_icp_base_namespace
{
                     ...
                     Eigen::Matrix3d &R, Eigen::Vector3d &t)
  {
    ...
    // 筛选最近邻匹配点的阈值，大于此阈值不考虑;
    double sqr_distance_th = 0.5;
    double cur_sqr_distance = 0.0;
    double last_sqr_distance = 0;
    ...
    for (size_t iter = 0; iter < n_iter; iter++)
    {
      ...
      } // for loop source; get pair and cost function
      ...
      if (cur_sqr_distance < min_err2_th || err_change < epsilon)
      {
